...
const [recommendedNames, setRecommendedNames] = useState([]);
  ...
  const addRecommendedName = () => {
    if (todo.trim() !== "") {
      setRecommendedNames((prevNames) => [...prevNames, todo.trim()]);
      settodo(""); // Clear the input after adding the name
    }
  };
...
//   };
  ...
  return (
    ...
    <div className='leftinputs'>
          ...
          <input type="text" name="BranchCode"  value={bank.BranchCode} placeholder='Branch Code'  onChange={(e) => handle(e)} />
          </div>

          <div className='col1'>
          <label htmlFor="">Branch Name *</label>
          <input type="text" name="BranchName" value={bank.BranchName} placeholder='Branch Name' onChange={(e) => handle(e)}/>
          </div>

          <div className='col1'>
          <label htmlFor="">Customer Name *</label>
          <input type="text" name="CustomerName" value={bank.CustomerName} placeholder='Customer Name'  onChange={(e) => handle(e)} />
          </div>


          <div className='col1'>
          <label htmlFor="">Customer Account Number *</label>
          <input type='number' name="CustomerAccountnumber"  value={bank.CustomerAccountnumber} placeholder='Customer Account Number'  onChange={(e) => handle(e)}/>
          </div>

          <div className='selection'>
          <label htmlFor="">Customer Account Type *</label>
          <select name="CustomerAccountType" value={bank.CustomerAccountType} id="accounttype"  onChange={(e) =>handle(e)}>
      ...
      <div className="innertable">
                    ...
                    <div className="two">
                      <label>
                        <input
                          ...
                          type="radio"
                          checked={question.answers != null ? !question.answers : null}
                          onChange={() => handleAnswerChange(test, false)}/>No</label>
                    </div>
                  </div>
                </div>
              )}
        ...
        {prop && (
         ...
         <div className="pro">
          {button &&(
          <button className='procebtn' onClick={procee}>Proceed to continue</button>
        ...
        <div className="div">
          ...
          {/* <div className="hh">
             ...
             <form className='rn' ><input type="text" value={todo} onChange={(event)=>settodo(event.target.value)} className='ii' /><button className="btnplus" onClick={addtodo}><AiOutlinePlus/></button>
             </form>
         ...
         <div className="hh">
            ...
            <form className="rn">
              <input
                ...
                className="ii"
              />
              <button className="btnplus" type="button" onClick={addRecommendedName}>
                <AiOutlinePlus />
              </button>
            </form>
            <ul>
              {recommendedNames.map((name, index) => (
                <div className="dltlist" key={index}>
                  <li>{name}</li>
                  <button className="btndlt" onClick={() => deleteRecommendedName(index)}>
                  <AiTwotoneDelete/>
                  </button>
                </div>
              ))}
